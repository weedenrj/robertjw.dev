...
function Text({
  ...
  switch (as) {
    case "span":
      return (
        <span className={clsx(className, "font-text", selectable ? "select-text" : "select-none")} {...rest}>
          {children}
        </span>
      )
    default:
      return (
        <p className={clsx(className, "font-text", selectable ? "select-text" : "select-none")} {...rest}>
          {children}
        </p>
      )
  }
