...
// zod becomes infinitely nested when importing? keep these schemas here
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = streamObject({
      ...
      system: `
      You are a schedule parsing specialist that analyzes work schedule images and extracts calendar events.
